...
sequelize.sync({ force: false }).then(() => {
    ...
    let band1 = await Band.create({ 
        ...
        users: [
            ...
            {name: "Alberto", age:22, email: "btooo@gmail.com"}
        ]
    },{
        include: 'users'
    });

    let user1 = await User.create( { name: "Anton", age: 38, email: "sergio@gmail.com" });
    ...
    //Other method add user
    let user3 = await User.create( { name: "Juan", age: 18, email: "sasdfqwe@gmail.com"});
